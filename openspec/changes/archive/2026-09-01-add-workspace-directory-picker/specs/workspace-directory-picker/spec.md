...
server process user's home directory and SHALL be displayed as `~`. This behavior SHALL be
the same on first launch and when opening another project. The picker SHALL NOT use the
